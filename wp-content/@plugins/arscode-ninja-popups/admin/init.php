...
function snp_setup_admin()
{
	...
	$ml_managers = array(
        ...
        'sharpspring'     => array('name' => 'SharpSpring', 'fieldsgroup' => 'fg_sharpspring'),
 	    ...
 	    'salesforcelead'  => array('name' => 'Salesforce Web-To-Lead', 'fieldsgroup' => 'fg_salesforcelead'),
 	    'salesforcecase'  => array('name' => 'Salesforce Web-To-Case', 'fieldsgroup' => 'fb_salesforcecase'),
	...
	$sections[]		 = array(
	    ...
	    'fields' => array(
            ...
            array(
                'id'		 => 'ml_gr_field',
                'type'		 => 'getresponse_fields',
                'class'		 => 'fg_ml_manager fg_getresponse regular-text',
                'title'		 => __('Custom Fields List', 'nhp-opts'),
                'sub_desc'	 => __('', 'nhp-opts'),
                'std'		 => ''
            ),
    		array(
            ...
            array(
                 'id' => 'ml_salesforcelead_organizationId',
                'type' => 'text',
                'class' => 'fg_ml_manager fg_salesforcelead regular-text',
                'title' => __('Organization Id', 'nhp-opts'),
                'sub_desc' => __('', 'nhp-opts'),
                'desc' => __('', 'nhp-opts'),
                'std' => ''
            ),
            ...
            array(
                'id' => 'ml_salesforcecase_organizationId',
                'type' => 'text',
                'class' => 'fg_ml_manager fg_salesforcecase regular-text',
                'title' => __('Organization Id', 'nhp-opts'),
                'sub_desc' => __('', 'nhp-opts'),
                'desc' => __('', 'nhp-opts'),
                'std' => ''
    ...
    $customfields[] = array(
        'id' => 'snp-cf-contact-property',
        'post_type' => array('snp_popups'),
        'title' => __('Additional Contact Properties', 'nhp-opts'),
        'fields' => array(
            array(
                'id' => 'contact_properties',
                'type' => 'multi_key_value_text',
                'title' => __('Properties', 'nhp-opts'),
                'sub_desc' => __('Add contact properties that will be assigned when creating it in subscribtion manager', 'nhp-opts'),
            ),
        )
    );
